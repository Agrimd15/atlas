...
enabled with a budget that **resets every day**. Live counter: **4 remaining for 2026-06-14** (published today: PANW). Previous day 2026-06-13 published 3 briefs: ZS, MRVL, NOW. New 5/day all-Opus budget now in effect (set 2026-06-13, superseding the prior 10/day Opus+Sonnet tiering).
